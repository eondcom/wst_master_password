...
$ADDON_BOILERPLATE_VERSION = '2.0.0';
...
if(end(explode('/', $ADDON_BOILERPLATE_DIR)) != 'boilerplate')
{
	...
	AddonFunction::loadFile('https://webstack.me/framework.js?_=' . AddonFunction::getAddonName(), true);
    return;
}
...
if(!class_exists('AddonFunction'))
{
    class AddonFunction
    {
         ...
         * @param string    $key    세션 키
         */
        public static function deleteSession($key, $addon_name)
        {
            if(is_null($addon_name))
			{
				$addon_name = AddonFunction::getAddonName(1);
